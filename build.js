...
const PACKAGE = `angular-library-lasitha`;
const NPM_DIR = `dist`;
...
shell.exec(`rollup -i ${NPM_DIR}/${PACKAGE}.js -o ${MODULES_DIR}/${PACKAGE}.js --sourcemap`, {
    silent: true
});
...
shell.exec(`tsc ${MODULES_DIR}/${PACKAGE}.es5.ts --target es5 --module es2015 --noLib --sourceMap`, {
    silent: true
});
