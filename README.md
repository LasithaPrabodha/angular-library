...
Get the [Changelog](https://github.com/LasithaPrabodha/angular-library/blob/master/CHANGELOG.md).
...
2. Rename `angular-library-lasitha` and `angularLibraryLasitha` everywhere to `my-library` and `myLibrary`.
...
1. `package.json`
    ...
    * `"main": "./bundles/angular-library-lasitha.umd.js"` legacy module format 
    * `"module": "./bundles/angular-library-lasitha.es5.js"` flat _ES_ module, for using module bundlers such as _Rollup_ or _webpack_: 
    [package module](https://github.com/rollup/rollup/wiki/pkg.module)
    * `"es2015": "./bundles/angular-library-lasitha.js"` _ES2015_ flat _ESM_ format, experimental _ES2015_ build
...
4. `rollup.config.js` file used by _Rollup_
    ...
    * `moduleName: 'ng.angularLibraryLasitha'` defines the global namespace used by _JavaScript_ apps
